...
public class boss extends Characters{
    ...
    private boolean isBossRun = false;
    private int imageIndex = 0;

    public final Image[] IMAGES_BOSS = {
            new ImageIcon(getClass().getResource("/images/Corona.png")).getImage(),
    };
    public boss(int x, int y, int orient, int timeMove) {
    ...
    public void draw(Graphics2D g2d) {
        g2d.drawImage(IMAGES_BOSS[0], x, y, SIZE, SIZE , null);
    }
    ...
    public Rectangle getRect() {
        Rectangle rectangle = new Rectangle(x, y , SIZE-8, SIZE-8 );
        return rectangle;
    }
